...
4. Load the unpacked extension in Chrome and at least one other Chromium-based
   browser such as Brave or Edge. Check the side panel at narrow and wide
   widths, URL prefill, direct and parameterized shortcuts, import/export,
   redirect rules, and behavior after restarting the browser.
...
named `Linker_X.Y.Z.chromium.zip` is attached to the automated GitHub Release
on the [Releases page](https://github.com/taichikuji/Linker/releases).
